...
class Print:
    ...
    def format(self):
        lines = {
            ...
            'composers': 'Composer: {}'.format(self.comp_lines(self.composition())),
            ...
            'composition_year': 'Composition Year: {}'.format(self.composition().year or ''),
            'edition': 'Edition: {}'.format(self.edition.name or ''),
            'editors': 'Editor: {}'.format(self.edit_lines(self.edition) or ''),
            'voices': '\n'.join(self.voice_lines(self.composition().voices)),
            'partiture': 'Partiture: {}'.format('yes' if self.partiture == True else 'no'),
